...
func _not_king_piece_activate(piece:int,pos:Vector2i,_is_black:bool,gameplay_scene:GameplayScene)->void:
	var piece_manager:PieceManager = gameplay_scene.piece_manager
	var to_duplicate:Piece = piece_manager.get_child(piece)
